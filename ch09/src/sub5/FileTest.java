...
public class FileTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("f2 티렉토리 여부 :  " + f2.isDirectory());
		System.out.println("f1 파일 이름 :  " + f1.getName());
		System.out.println("f2 파일 이름 :  " + f2.getName());
		System.out.println("f1 파일 경로 :  " + f1.getPath());
		System.out.println("f2 파일 경로 :  " + f1.getPath());
		System.out.println("f1 파일 절대 경로 :  " + f1.getAbsolutePath());
		System.out.println("f2 파일 절대 경로 :  " + f2.getAbsolutePath());
